...
const Navbar = () => {
  ...
  return (
    <nav
      className="w-full flex items-center bg-gradient-to-b from-black sm:bg-none p-8 sm:px-16 sm:py-10 fixed z-40 pointer-events-auto"
    >
      <div className='w-full flex justify-between items-start mx-auto'>
        ...
        <ul className='list-none hidden sm:flex flex-col gap-5'>
          {navLinks.map((nav) => (
            ...
            >
              {active === nav.id && (
                <div className="fixed right-10 w-2 h-6 lg:h-8 bg-white"></div>
              )}
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          <button
            alt='Menu'
            className='text-white focus:outline-none  w-[28px] h-[28px] object-contain pointer-events-auto cursor-pointer'
          ...
          >
            <div className="bg-gray-900 mt-[-20px] mr-[-10px] p-6 rounded-xl shadow-lg border-2 border-white">
